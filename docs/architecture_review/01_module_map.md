...
| `readiness` | Derived Ready for Sale policy; no persisted readiness status | `GET /api/readiness/variants/{id}/ready-for-sale` | `ReadyForSaleService` | `catalog`, `media`, `pricing` | Intake completion, Labels, AQSI; future attention queue |

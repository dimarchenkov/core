...
- Проведение и отмена одного Receipt сериализуются блокировкой строки документа.
- Отмена создаёт точные reversal-движения по исходным движениям, а не по текущим ReceiptItem.
